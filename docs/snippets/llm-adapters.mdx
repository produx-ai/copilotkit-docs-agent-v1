...
<!-- CORRECTED: Added missing adapters that are available in the runtime package but were not listed in the documentation -->
- [Bedrock Adapter](/reference/classes/llm-adapters/BedrockAdapter)
- [Unify Adapter](/reference/classes/llm-adapters/UnifyAdapter)
