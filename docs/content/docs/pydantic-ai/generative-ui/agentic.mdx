...
<Callout type="warn">
  A dedicated Pydantic AI agentic generative UI demo is not yet available. Please refer to the code examples below while we work on adding a feature viewer demo.
</Callout>
