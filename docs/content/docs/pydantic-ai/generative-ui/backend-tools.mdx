...
<IframeSwitcher
  ...
  exampleUrl="https://feature-viewer.copilotkit.ai/pydantic-ai/feature/backend_tool_rendering?sidebar=false&chatDefaultOpen=false"
  codeUrl="https://feature-viewer.copilotkit.ai/pydantic-ai/feature/backend_tool_rendering?view=code&sidebar=false&codeLayout=tabs"
  exampleLabel="Demo"
  codeLabel="Code"
  height="700px"
/>
...
<Callout type="warn">
  Note: A dedicated Pydantic AI demo is not yet available; links currently redirect to a generic example or feature viewer.
</Callout>
