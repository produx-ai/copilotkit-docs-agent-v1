...
<FrameworkOverview
  ...
  // Deep-link to the AG2 feature viewer instead of the feature viewer homepage.
  ...
  supportedFeatures={[
    {
      ...
      // Point directly to an AG2 generative UI example in the feature viewer (matches the deep-link pattern used by other frameworks).
      demoLink: "https://feature-viewer.copilotkit.ai/ag2/feature/tool_based_generative_ui",
