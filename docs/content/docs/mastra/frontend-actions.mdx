...
This can be utilized to let [your agent control the UI](/mastra/generative-ui/index), [generative UI](/mastra/generative-ui/frontend-tools), or for Human-in-the-loop interactions.
