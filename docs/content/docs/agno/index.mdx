...
<FrameworkOverview
  frameworkName="Agno"
  // The Agno icon is available in customIcons (see docs/lib/icons/custom-icons.tsx); this was previously left blank.
  frameworkIcon={<customIcons.agno className="h-10 w-10" />}
