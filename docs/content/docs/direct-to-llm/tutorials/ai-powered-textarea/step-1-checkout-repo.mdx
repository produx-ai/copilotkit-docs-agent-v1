...
We'll begin by checking out the base code of the email application. We'll start from the `base-start-here` branch.
```shell
...
You should be able to go to [http://localhost:3000](http://localhost:3000) and see the email application. Feel free to play around with the app to get a feel for it.
</Steps>
