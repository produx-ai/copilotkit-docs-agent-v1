...
<div className="flex flex-col shadow-lg rounded-lg my-4">
  <div className="bg-neutral-800 h-11 rounded-t-lg flex items-center px-4">
    {/* Fixed: Changed title from "Todo List" to "Email" to match tutorial content */}
    <div className="flex-1 text-center text-white font-medium">CopilotKit Email Textarea Copilot Demo</div>
  </div>
  <iframe
