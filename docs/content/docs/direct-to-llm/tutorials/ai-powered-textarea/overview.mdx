...
In this tutorial, you will take a simple text composition app and add AI-powered autocompletion to it. The app uses a textarea for composing text, and you'll add CopilotKit to provide relevant autocompletions as you type. The textarea will be aware of additional context provided to the copilot.
## What you'll learn
...
<div className="flex flex-col shadow-lg rounded-lg my-4">
  <div className="bg-neutral-800 h-11 rounded-t-lg flex items-center px-4">
    <div className="flex-1 text-center text-white font-medium">CopilotKit Textarea Demo</div>
  </div>
  <iframe
