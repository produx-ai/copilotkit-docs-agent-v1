...
<Cards>
  <Card
    ...
    href="/direct-to-llm/guides/custom-look-and-feel/built-in-ui-components"
  />
  <Card
    className="border border-gray-300 hover:border-gray-400 transition-colors"
  ...
  <Card
    ...
    href="/direct-to-llm/guides/custom-look-and-feel/bring-your-own-components"
  />
  <Card
    className="border border-gray-300 hover:border-gray-400 transition-colors"
    ...
    href="/direct-to-llm/guides/custom-look-and-feel/headless-ui"
  />
  <Card
    className="border border-gray-300 hover:border-gray-400 transition-colors"
    ...
    href="/direct-to-llm/guides/custom-look-and-feel/markdown-rendering"
  />
</Cards>
<!-- Updated href paths from relative (./custom-look-and-feel/...) to absolute (/direct-to-llm/guides/custom-look-and-feel/...) to match the routing pattern used in other index files in the guides directory (backend-actions, connect-your-data). See backend-actions/index.mdx and connect-your-data/index.mdx for reference. -->
