...
<Steps>
        ...
        parameters: [
    {
        ...
        name: "displayUser", // Frontend action name (can differ from backend action name) // [!code highlight]
        pairedAction: "fetchUser", // Choose which backend action this is paired with // [!code highlight]
        ```
    </Step>
