...
- Familiarize yourself with [FumaDocs](https://fumadocs.vercel.app/) to understand how the documentation website is structured—it's built on Next.js App Router with MDX support.
