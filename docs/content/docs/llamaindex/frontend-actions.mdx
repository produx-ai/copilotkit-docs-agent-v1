...
This can be utilized to let [your agent control the UI](#implementation), [generative UI](/llamaindex/generative-ui/frontend-tools), or for Human-in-the-loop interactions.
