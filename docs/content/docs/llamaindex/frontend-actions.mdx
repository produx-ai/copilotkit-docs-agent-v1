...
This can be utilized to let [your agent control the UI](#what-is-this), [generative UI](/llamaindex/generative-ui/frontend-tools), or for Human-in-the-loop interactions. <!-- PATCH: the original link pointed to this same page; using an in-page anchor makes the intent explicit and avoids a redundant self-navigation. -->
