...
This can be utilized for to let [your agent control the UI](/llamaindex/frontend-actions#implementation), [generative UI](/llamaindex/generative-ui/frontend-tools), or for Human-in-the-loop interactions.
