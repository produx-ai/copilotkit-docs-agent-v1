    ...
    >
        ...
        <TailoredContentOption
            ...
            <Step>
                ...
                **Note**: If you don't have `uv` installed, use standard Python tools instead:
                - Instead of `uv init my-agent`, use: `mkdir my-agent && cd my-agent && python -m venv venv`
                - Instead of `uv add <packages>`, use: `pip install <packages>`
            </Step>
            <Step>
