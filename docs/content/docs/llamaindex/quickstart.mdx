    ...
    >
        ...
        >
            ...
            <Step>
                ...
                ```bash
                # NOTE: The CLI-generated template includes its own package manifests.
                # Run your package manager install in the generated project directories.
                npm install
                ```
            <Step>
        ...
        >
            ...
            <Step>
                ...
                ```bash
                # NOTE: Install the CopilotKit + AG-UI client packages used below.
            ...
            <Step>
                ...
                import { HttpAgent } from "@ag-ui/client"; // NOTE: LlamaIndex connects via the generic AG-UI HttpAgent
                ...
                const runtime = new CopilotRuntime({
                  agents: {
                    // NOTE: Agent name must match the `agent` prop on <CopilotKit />
                    my_agent: new HttpAgent({ url: "http://localhost:8000/run" }),
                  },
                });
            ...
            <Step>
                ...
                Wrap your application with the CopilotKit provider:
                        <CopilotKit runtimeUrl="/api/copilotkit" agent="my_agent"> {/* NOTE: `agent` selects the default agent key from runtime.agents */}
                          {children}
                        </CopilotKit>
