...
<Steps>
  ...
  <Step>
    ...
    {/* NOTE: `get_ag_ui_workflow_router` is imported from `llama_index.protocols.ag_ui.router` across our LlamaIndex docs and examples in this repo. */}
  ...
  <Step>
    ...
    {/* NOTE: Link verified to exist in this docs repo at docs/content/docs/reference/hooks/useCoAgent.mdx */}
    {/* NOTE: Using `useCoAgent<AgentState>` ensures `state.language` is typed as "english" | "spanish" in this example. */}
...
{/* NOTE: Link verified to exist in this docs repo at docs/content/docs/reference/hooks/useCoAgentStateRender.mdx */}
```tsx title="ui/app/page.tsx"
