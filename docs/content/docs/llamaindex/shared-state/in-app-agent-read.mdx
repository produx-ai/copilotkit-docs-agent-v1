...
<Callout type="info">
  This example demonstrates reading from shared state in the [CopilotKit Feature Viewer](https://feature-viewer.copilotkit.ai/llama-index/feature/shared_state). This is an external demo service and may not always reflect the exact code shown here.
</Callout>
...
<Steps>
  ...
  <Step>
    ...
    # Note: These imports come from the LlamaIndex package. Check LlamaIndex docs for API stability.
