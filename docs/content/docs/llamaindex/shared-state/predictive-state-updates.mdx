...
{/* NOTE: This example iframe remains commented out because the referenced dojo example is not tracked/validated in this docs repo. */}
...
<Steps>
  ...
  <Step>
    ...
    >
        ...
        >
            ...
            # NOTE: `StateSnapshotWorkflowEvent` is imported from `llama_index.protocols.ag_ui.events` in the llamaindex starter example in this repo.
  ...
  <Step>
    ...
    export default function Page() {
        ...
        // NOTE: `useCoAgentStateRender` passes `status` as "inProgress" | "complete" (see CoAgentStateRenderProps in @copilotkit/react-core).
                ...
                return (
                    <div className="p-4 bg-gray-50 rounded-lg border border-gray-200 my-2">
                        <h3 className="font-semibold text-gray-700 mb-2">
                            {status === 'inProgress' ? '⏳ Progress:' : '✅ Complete:'}
                        </h3>
