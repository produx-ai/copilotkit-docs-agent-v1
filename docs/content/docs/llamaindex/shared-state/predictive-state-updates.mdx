        ...
        header={
            <div>
                ...
                <p className="text-base">
                    {/* Doc fix: This page currently demonstrates only the tool-based approach below, so avoid implying a second (missing) option. */}
                    Configure specific tool calls to emit intermediate state updates.
                </p>
        }
    >
