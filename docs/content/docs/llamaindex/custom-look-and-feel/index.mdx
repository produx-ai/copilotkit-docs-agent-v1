...
<Cards>
  <Card
    ...
    href="./built-in-ui-components" // docs path is already /llamaindex/custom-look-and-feel; avoid duplicating /custom-look-and-feel/ in the URL
  />
  <Card
    className="border border-gray-300 hover:border-gray-400 transition-colors"
    ...
    href="./customize-built-in-ui-components" // docs path is already /llamaindex/custom-look-and-feel; avoid duplicating /custom-look-and-feel/ in the URL
  />
  <Card
    className="border border-gray-300 hover:border-gray-400 transition-colors"
    ...
    href="./bring-your-own-components" // docs path is already /llamaindex/custom-look-and-feel; avoid duplicating /custom-look-and-feel/ in the URL
  />
  <Card
    className="border border-gray-300 hover:border-gray-400 transition-colors"
    ...
    href="./headless-ui" // docs path is already /llamaindex/custom-look-and-feel; avoid duplicating /custom-look-and-feel/ in the URL
  />
  <Card
    className="border border-gray-300 hover:border-gray-400 transition-colors"
    ...
    href="./markdown-rendering" // docs path is already /llamaindex/custom-look-and-feel; avoid duplicating /custom-look-and-feel/ in the URL
  />
  />
</Cards>