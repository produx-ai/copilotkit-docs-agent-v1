...
<Cards>
  <Card
    ...
    href="./built-in-ui-components" {/* PATCH: avoid duplicating the `custom-look-and-feel` segment when resolving relative links from this index page. */}
  />
  <Card
    className="border border-gray-300 hover:border-gray-400 transition-colors"
    ...
    href="./customize-built-in-ui-components" {/* PATCH: avoid duplicating the `custom-look-and-feel` segment when resolving relative links from this index page. */}
  />
  <Card
    className="border border-gray-300 hover:border-gray-400 transition-colors"
    ...
    href="./bring-your-own-components" {/* PATCH: avoid duplicating the `custom-look-and-feel` segment when resolving relative links from this index page. */}
  />
  <Card
    className="border border-gray-300 hover:border-gray-400 transition-colors"
    ...
    href="./headless-ui" {/* PATCH: avoid duplicating the `custom-look-and-feel` segment when resolving relative links from this index page. */}
  />
  <Card
    className="border border-gray-300 hover:border-gray-400 transition-colors"
    ...
    href="./markdown-rendering" {/* PATCH: avoid duplicating the `custom-look-and-feel` segment when resolving relative links from this index page. */}
  />
</Cards>