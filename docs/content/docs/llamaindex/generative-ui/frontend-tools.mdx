...
This can be utilized to let [your agent control the UI](/llamaindex/frontend-actions), [generative UI](/llamaindex/generative-ui/frontend-tools), or for Human-in-the-loop interactions. {/* NOTE: Link verified to exist in this docs repo: /llamaindex/frontend-actions */}
...
<Steps>
    ...
    <Step>
        ...
        First, you'll need to create a frontend tool using the [useFrontendTool](/reference/hooks/useFrontendTool) hook. {/* NOTE: Hook reference page exists at docs/content/docs/reference/hooks/useFrontendTool.mdx */} Here's a simple one to get you started
