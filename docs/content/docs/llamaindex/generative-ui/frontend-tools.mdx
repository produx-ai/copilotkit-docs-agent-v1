...
This can be utilized to let [your agent control the UI](/llamaindex/frontend-actions), [generative UI](/llamaindex/generative-ui), or for Human-in-the-loop interactions. <!-- PATCH: Fix self-referential link; point to Generative UI overview page instead of this same page. -->
