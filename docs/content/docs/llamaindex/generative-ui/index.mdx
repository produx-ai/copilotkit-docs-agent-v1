...
<Callout>
  ...
  making use of Generative UI! <!-- PATCH: `/llamaindex/videos/research-canvas` does not exist in this repo; the existing page is under `/langgraph/videos/research-canvas`. -->
</Callout>
