...
<Steps>
  ...
  <Step>
        ...
        parameters: [
          {
            name: "feedback",
            type: "string",
            description: "The user's approval or rejection response",
          },
        ],
    ...
    - Reference this working example: [coagents-starter-crewai-crews with HITL](https://github.com/CopilotKit/CopilotKit/tree/main/examples/coagents-starter-crewai-crews)
