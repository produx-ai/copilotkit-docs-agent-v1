...
<FrameworkOverview
  ...
  {/* Fix: /coagents/... routes are not present in this docs tree; CrewAI Flows documentation lives under /crewai-flows/... */}
  supportedFeatures={[
    {
      title: "Generative UI",
  ...
  architectureVideo="https://cdn.copilotkit.ai/docs/copilotkit/images/coagents/crew-ai/flows/crews-interaction-layer.mp4" // docs-fix: remove duplicated prop introduced during link updates.
  liveDemos={[
    {
      type: "saas",
      title: "SaaS Copilot",
