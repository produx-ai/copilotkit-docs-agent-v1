...
- [Node.js](https://nodejs.org/en/) 18.x or later (20.x recommended)
- [pnpm](https://pnpm.io/) v9.x or later installed globally (`npm i -g pnpm`)
...
<Steps>
  ...
  The documentation site should be available at [http://localhost:3001](http://localhost:3001).
  </Step>
  <Step>
  ### Make Your Changes
  ...
  - You may want to familiarize yourself with [Fumadocs](https://fumadocs.vercel.app/) to understand how the documentation website is structured.
