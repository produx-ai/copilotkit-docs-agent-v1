...
In headless setups, the output of `render` isn't displayed automatically—render it yourself inside your custom chat UI (e.g., when mapping over `messages` and handling tool calls).
