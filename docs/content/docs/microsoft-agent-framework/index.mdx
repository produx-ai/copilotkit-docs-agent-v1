...
<FrameworkOverview
  ...
  supportedFeatures={[
    ...
    },
    {
      ...
      // Deep-link to the Microsoft Agent Framework feature viewer example (other MAF docs use this exact path).
      demoLink: "https://feature-viewer.copilotkit.ai/microsoft-agent-framework-dotnet/feature/human_in_the_loop",
    ...
    },
    {
      ...
      // Deep-link to the Microsoft Agent Framework shared_state demo to avoid sending users to the feature viewer homepage.
      demoLink: "https://feature-viewer.copilotkit.ai/microsoft-agent-framework-dotnet/feature/shared_state",
