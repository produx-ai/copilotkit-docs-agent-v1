...
<FrameworkOverview
  ...
  supportedFeatures={[
    {
      ...
      documentationLink: "/langgraph/generative-ui", // docs-fix: LangGraph docs live under /langgraph (the previous /coagents path was inconsistent with this section).
    ...
    },
    {
      ...
      documentationLink: "/langgraph/human-in-the-loop", // docs-fix: update to the LangGraph section route.
    ...
    },
    {
      ...
      documentationLink: "/langgraph/shared-state", // docs-fix: update to the LangGraph section route.
  ...
  ]} // docs-fix: updated supportedFeatures documentation links to use the /langgraph routes.
  ...
  {/* docs-fix: tutorial lives under /langgraph/tutorials/ai-travel-app in this docs tree (docs/content/docs/langgraph/tutorials/ai-travel-app). */}
