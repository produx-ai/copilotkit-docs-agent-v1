...
<Steps>
  ...
  <Callout type="warning">
    While the site runs without setup, some optional features (e.g., analytics or embedded demos) may require environment variables in `.env.local` for full functionality.
  </Callout>
