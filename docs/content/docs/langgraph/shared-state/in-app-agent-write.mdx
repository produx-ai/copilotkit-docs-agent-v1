...
See **[predictive state updates](/langgraph/shared-state/predictive-state-updates).** <!-- Fix: update outdated /coagents/ link to the LangGraph docs route to match this section's location -->
