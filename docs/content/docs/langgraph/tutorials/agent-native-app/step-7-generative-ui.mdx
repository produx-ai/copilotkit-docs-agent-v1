...
# ...
from copilotkit.langgraph import copilotkit_emit_state # [!code ++] <!-- docs-fix: use LangGraph SDK import; copilotkit.langchain is deprecated -->
#...
...
export default function HomePage() { // <!-- docs-fix: this component belongs in page.tsx (title previously said layout.tsx) -->
    //...
