...
<Callout type="info">
We recommend using a virtual environment for your project to keep your packages contained. Create one with `python -m venv venv` and activate it with `source venv/bin/activate`. See the Python venv docs for details.
</Callout>
...
This opens LangGraph Studio in your browser where you can visualize and interact with your agent.
