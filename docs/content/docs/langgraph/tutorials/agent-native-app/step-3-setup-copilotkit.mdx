...
Once logged in, you'll see some onboarding steps. <!-- docs-fix: "on boarding" -> "onboarding" --> The main thing we'll need is a public API key. To do this,
...
We provide several customizable components for you to interact with your copilot. <!-- docs-fix: "customizeable" -> "customizable" --> Some of these are [`<CopilotPopup/>`](/reference/components/chat/CopilotPopup), [`<CopilotSidebar/>`](/reference/components/chat/CopilotSidebar), and [`<CopilotChat/>`](/reference/components/chat/CopilotChat), and your own fully custom UI via [`useCopilotChat`](/reference/hooks/useCopilotChat).
