...
<div className="flex flex-row gap-2">
  <Button size="lg" asChild className="flex gap-2 items-center">
    {/* docs-fix: Remove the non-essential `ref` query param to keep the GitHub link stable and less likely to break due to marketing/branch ref changes. */}
    <Link href="https://github.com/CopilotKit/CopilotKit/tree/main/examples/coagents-travel" className="no-underline" target="_blank">
