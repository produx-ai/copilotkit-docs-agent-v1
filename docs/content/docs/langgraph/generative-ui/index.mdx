...
<Callout>
    This example shows our [Research Canvas](/langgraph/videos/research-canvas) making use of Generative UI! {/* docs-fix: update link to the LangGraph videos route; previous /coagents path was inconsistent with this section. */}
</Callout>
