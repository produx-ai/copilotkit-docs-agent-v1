...
- [Configure your LangGraph Platform deployment →](/langgraph/quickstart) // docs-fix: LangGraph quickstart page is under /langgraph; previous /coagents path was outdated.
- [Learn about agent state management →](/langgraph/shared-state) // docs-fix: update to LangGraph shared-state route.
- [Implement human-in-the-loop workflows →](/langgraph/human-in-the-loop) // docs-fix: update to LangGraph HITL route.
