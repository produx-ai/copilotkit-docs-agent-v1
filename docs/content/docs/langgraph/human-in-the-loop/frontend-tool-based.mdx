...
This can be utilized to let [your agent control the UI](/langgraph/frontend-actions), [generative UI](/langgraph/generative-ui/frontend-tools), or for Human-in-the-loop interactions.
<!-- Docs fix: Removed the ungrammatical phrase "for to let" as flagged in the verification report. -->
