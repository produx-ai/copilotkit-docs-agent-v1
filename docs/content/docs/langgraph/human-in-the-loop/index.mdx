...
<Callout>
  {/* Docs fix: Link to the LangGraph tutorial path (avoid relying on legacy /coagents redirects). */}
...
<Callout>
  {/* Docs fix: Use canonical /langgraph paths for HITL subpages. */}
...
<CTACards
  ...
  cards={[
    ...
    },
    {
      ...
      href: "/langgraph/human-in-the-loop/node-flow"
    }
  ]}
/>
  ]}
