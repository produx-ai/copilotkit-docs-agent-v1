...
Controls the visibility of the stop button during response generation. When true, the stop button is hidden and users cannot interrupt an in-progress reply.
</PropertyReference>
