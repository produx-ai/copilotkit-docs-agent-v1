...
`useCopilotChatSuggestions` is a React hook that generates chat suggestions based on your instructions and (optionally) monitored app state changes. It registers with the chat context on mount and unregisters on unmount to keep suggestions in sync with your chat UI.
<br/>
