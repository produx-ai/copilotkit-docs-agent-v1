...
<PropertyReference name="langgraph_config" type="Optional[Union[RunnableConfig, dict]]" > 
The LangGraph/LangChain config to use with the agent. Accepts either a RunnableConfig or a plain dict.
</PropertyReference>
...
<PropertyReference name="merge_state" type="Callable" > 
This function lets you customize how CopilotKit merges the agent state.
</PropertyReference>

<PropertyReference name="convert_messages" type="Callable" > 
